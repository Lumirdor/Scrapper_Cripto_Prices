...
function grabar(contenido){
  const nombreArchivo = 'precios8.csv'
  //let nueva_info = "";
...
binance.candlesticks("BTCUSDT", "1m", (error, ticks, symbol) => {
    ...
    //console.log(typeof contenido2CSV);
    //const contenido2_CSV = ticks.map(row => row.join(',')).join('\n');
    contenido_CSV = ticks.map(row => row.join(',')).join('\n');
    //contenido_CSV = contenido2_CSV;
   // const nombreArchivo2 = 'precios.csv';
    /********************************************************************* */
    //console.log("Aca ta1 "+ contenido_CSV + "Aca llega");

    

    grabar(contenido_CSV)
/*
...
console.log("Aca ta"+ contenido_CSV + "Aca llega");
/********************************************* SEGUNDA PARTE*************************************************** */
